...
- 💻 Working with **Java, Python, JavaScript/HTML/CSS and GDScript**  
- 🎨 Also using **Figma, Blender, Godot, DaVinci and Affinity**  
- 🔍 Always trying to learn new tech and improving my skills  
